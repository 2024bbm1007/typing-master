export const ESSAYS = [
  ...
  },
  {
    ...
    difficulty: "advanced",
    text: "The landscape of education has transformed dramatically with technology. Online learning platforms provide access to world-class courses from anywhere. Interactive simulations make complex concepts tangible, while adaptive learning systems personalize education to individual needs. However, digital education also presents challenges maintaining engagement, ensuring equitable access, and developing social skills. The future of education likely combines technology's strengths with traditional learning's irreplaceable human elements.",
    estimatedTime: 6
  },
  {
    id:  15,
    ...
    difficulty: "intermediate",
    text: "Creativity is not limited to artists and musicians it is essential for problem-solving, innovation, and personal fulfillment. Everyone possesses creative potential, though it may manifest differently. Creativity flourishes when we allow ourselves to experiment without fear of failure. Taking time for reflection, exploring diverse experiences, and connecting seemingly unrelated ideas all nurture creative thinking.",
    estimatedTime: 5
  },
  {
    id: 16,
    ...
    difficulty: "intermediate",
    text: "Mental health is as important as physical health, yet it often receives less attention. Stress, anxiety, and depression affect millions worldwide, impacting quality of life and productivity. Recognizing mental health challenges and seeking help demonstrates strength, not weakness. Exercise, social connections, adequate sleep, and professional support all contribute to mental well-being. Creating supportive environments reduces stigma.",
    estimatedTime: 5
  },
  {
    id: 17,
    ...
    difficulty:  "intermediate",
    text: "Effective time management enables us to accomplish more while maintaining balance. Prioritization separates urgent tasks from important ones, ensuring focus on what truly matters. Breaking large projects into smaller steps makes them manageable. Eliminating distractions and batching similar tasks improves efficiency. However, perfect productivity should not come at the expense of rest and relationships.",
    estimatedTime: 5
  },
  {
    id: 18,
    ...
    difficulty: "advanced",
    text: "Understanding how the brain learns helps us study more effectively. Spaced repetition strengthens memory better than cramming. Active recall testing yourself improves retention more than passive review. Interleaving different topics builds flexible understanding. Sleep consolidates memories, making rest crucial for learning. Mistakes are not failures but essential feedback that guides improvement.",
    estimatedTime: 6
  },
  {
    id: 19,
    ...
    difficulty: "advanced",
    text: "The nature of work continues evolving rapidly. Remote work became mainstream, proving many jobs can be done from anywhere. Automation handles routine tasks, freeing humans for creative and strategic work. Gig economy platforms provide flexibility but raise questions about benefits and stability. Lifelong learning is essential as skills become obsolete faster. Success requires adaptability, continuous learning, and strong communication skills.",
    estimatedTime: 6
  },
  {
    id: 20,
